...
class UserChangeForm(forms.ModelForm):
    ...
    def clean_password(self):  # We don't have access to the original value in the field itself, so we use clean
        return self.initial['password']  # initial password value
